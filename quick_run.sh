...
-e AZURE_SQL_PASSWD=${AZURE_SQL_PASSWD} -e AZURE_SQL_USERNAME=${AZURE_SQL_USERNAME} -e LOGIN_DISABLED=True -e DB_TYPE=${DB_TYPE} -e MYSQL_PASSWD=${MYSQL_PASSWD} gene_data_explorer
